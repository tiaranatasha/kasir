...
$penjualan = $conn->query("SELECT p.penjualan_id, p.tanggal_penjualan, pl.nama_pelanggan, p.total_harga 
                           FROM penjualan p 
...
<body>
    <div class="sidebar">
        ...
        <a href="lihat_penjualan.php" class="active">📋 Lihat Penjualan</a>
